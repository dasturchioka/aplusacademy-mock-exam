...
import { TFNGBlock } from "@/components/admin/reading/TrueFalseNotGiven";
...
export default function TrueFalseNotGivenExam({
  question,
  onAnswerChange,
}: {
  question: TFNGBlock;
    ...
    <div className="space-y-4">
      ...
      {question.headline && (
        <div className="text-center w-full flex items-center justify-center my-4">
          <StableHtml as="p" className="font-bold" html={question.headline} />
        </div>
      )}

  ...
  return (
    <div className="space-y-6">
              ...
              <React.Fragment key={node.id}>
                <div className="border p-4 rounded-xl">
                  {node.isInteractive ? (
                    ...
                    <StableHtml as="div" html={processTextWithBoldAndCaps(node.text)} />
                  )}
                </div>
                  ...
                  <div className="mb-3">
                    {question.optionsHeadline && (
                      <StableHtml
                        ...
                        html={processTextWithBoldAndCaps(question.optionsHeadline)}
                      />
                    )}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            >
                              <StableHtml as="span" html={processTextWithBoldAndCaps(option.label)} />
                            </span>
                            <span
                              className={`${
                            ...
                            >
                              <StableHtml as="span" html={processTextWithBoldAndCaps(option.text)} />
                            </span>
                          </div>
                        </div>
                      );
      ...
      {question.answerConstraints && (
        <StableHtml as="p" className="text-muted-foreground" html={processTextWithBoldAndCaps(question.answerConstraints)} />
      )}
    </div>
  );
}

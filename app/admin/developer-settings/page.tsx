...
export default function DeveloperSettingsPage() {
  ...
  const handleDownloadAudios = async () => {
    try {
      ...
      notify.info("Processing audio files...", "This may take a moment. Please wait.");

      const response = await fetch(
        `${API_BASE_URL}/api/developer/download-audios?deleteUnused=${deleteUnused}`,
        {
          method: "GET",
        }
      );
